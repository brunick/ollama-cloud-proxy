...
## [1.20.11] - 2026-01-18
### Added
- 🛡️ **Robust Token Tracking**: Regex-Fallback für die Token-Extraktion hinzugefügt. Dies stellt sicher, dass auch bei großen non-streaming Antworten oder hübsch formatiertem JSON die Token-Statistiken korrekt erfasst werden, selbst wenn der Puffer am Ende abgeschnitten ist (#49).
